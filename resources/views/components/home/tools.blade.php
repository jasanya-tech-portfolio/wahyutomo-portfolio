...
<div class="flex justify-center pt-4 font-[Poppins]">
    <div class="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full text-sm text-blue-600 font-semibold shadow-sm hover:shadow-md max-w-[240px] border-2 border-blue-100">
        <!--Ikon ping -->
