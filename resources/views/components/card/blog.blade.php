<div class="bg-gray-100">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-2 py-12 font-[poppins]">
        @foreach ($blogs as $blog)
            <div class="bg-white w-[418px] h-[295px] mx-auto my-auto shadow-sm hover:shadow-lg border-gray-300 hover:border-2">
                {{-- Title --}}
