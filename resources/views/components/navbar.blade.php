<nav id="navbar scroll" class="bg-white/75 p-2 fixed top-0 left-0 right-0 z-50">
    {{-- Logo --}}
    ...
    <div class="flex items-center justify-between px-10">
        ...
        <a href="/" class="flex items-center">
            <img src="{{App\Helpers\BannerHelper::getBannerImageUrl('logo')}}" alt="Logo" class="h-10 w-auto">
        </a>
        {{-- Navigation Links --}}
        <ul
            id="menu"
