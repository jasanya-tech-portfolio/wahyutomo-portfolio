...
@section('content')
    ...
    <div class="fixed right-6 bottom-10 flex flex-col items-center space-y-4 z-[9999]">
        <div
            ...
            class="relative w-14 h-14 bg-white border border-gray-300 rounded-full flex items-center justify-center cursor-pointer shadow-md transition-transform duration-200 hover:scale-110 hover:shadow-indigo-300"
        ...
        >
            ...
            <!-- Arrow Icon -->
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="#605dba" class="w-6 h-6 z-[2]">
        ...
        <a href="https://wa.me/{{ App\Helpers\SettingHelper::getSetting('wa') }}" target="_blank" title="Chat WhatsApp">
            <div
                class="relative w-14 h-14 cursor-pointer flex items-center justify-center shadow-[inset_0_0_0_0.1rem_rgba(128,130,134,0.25)] bg-white rounded-full hover:scale-110 hover:shadow-lg hover:shadow-green-300 transition-all duration-300 ease-in-out">
                <!-- WhatsApp Icon -->
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="w-6 h-6 fill-[#25D366] z-[2]">
